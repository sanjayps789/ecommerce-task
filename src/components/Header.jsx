       ...
       <Navbar expand="lg" className="bg-light w-100 position-fixed py-4" style={{zIndex:1}}>
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav.Link><Link className='fw-medium text-black text-decoration-none' to={'/'}>Home</Link></Nav.Link>
            <Nav.Link><Link className='fw-medium text-black text-decoration-none' to={'/allproducts'}>Products</Link></Nav.Link>
            <Nav.Link>
              <Link className='fw-medium text-black text-decoration-none' to={'/users'}>Users</Link>
              </Nav.Link>
